# RHEL 10.2 — Configuración base tras la instalación

## 1. Objetivo
Dejar `rhel10-app01` registrado, actualizado y coherente con el resto del laboratorio antes de las Etapas 2-4.

## 2. Prerrequisitos
Instalación completada (`rhel10/installation.md`), acceso `ssh rhel10-app01`.
...
| Paso | Comando | Notas |
|---|---|---|
| Registro | `scripts/lab.sh register rhel10-app01 <usuario>` | La contraseña se pide en la VM, no en la línea de comandos |
...
| Red | `nmcli -f NAME,FILENAME con show` | Formato de perfil: **ifcfg eliminado**: solo keyfile ✔ |
| Inventario | `scripts/lab.sh facts rhel10-app01` | Alimenta la matriz de comparación |
...
## 8. Diferencias
Ver `rhel10/differences.md` y `comparison/matrix.md`.
